...
import (
	...
	networkHelper "github.com/simplecontainer/smr/pkg/network"
...
func (network *Network) ListSupported(request contracts.Control) contracts.Response {
	return contracts.Response{
		...
		Error:            false,
		Success:          true,
		Data:             networkHelper.ToJson(supportedControlOperations),
	}
}
...
func (network *Network) List(request contracts.Control) contracts.Response {
	...
	return contracts.Response{
		...
		Error:            false,
		Success:          true,
		Data:             networkHelper.ToJson(data),
	}
}
...
func (network *Network) Get(request contracts.Control) contracts.Response {
	...
	return contracts.Response{
		...
		Error:            false,
		Success:          true,
		Data:             networkHelper.ToJson(definition),
	}
}
