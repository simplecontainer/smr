...
func TestStandaloneNodeMinimalContainer(t *testing.T) {
	...
	cli.Smrctl.Run(t, engine.NewStringCmd("apply %s/../examples/tests/minimal/definitions/Containers.yaml", cli.Root))
	...
	cli.Smrctl.Run(t, engine.NewStringCmd("remove %s/../examples/tests/minimal/definitions/Containers.yaml", cli.Root))
